# Contributing to CraftCoin Core

CraftCoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/craftcoin/craftcoin/labels/help%20wanted)
* [Projects](https://github.com/craftcoin/craftcoin/projects)
* [craftcoindev on reddit](https://www.reddit.com/r/craftcoindev/)

## Branch Strategy

CraftCoin Core's default branch is intentionally a stable release, so that anyone
...
CraftCoin Core is a direct fork of Bitcoin Core and therefore benefits from as
