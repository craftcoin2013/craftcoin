...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Core and CraftCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Core and CraftCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/CraftcoinCommunity/craftcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CraftCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CraftCoin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "craftcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://github.com/CraftcoinCommunity/craftcoin"
