...
// CraftCoin: Normally minimum difficulty blocks can only occur in between
...
bool CheckAuxPowProofOfWork(const CBlockHeader& block, const Consensus::Params& params)
{
    ...
    if (!block.auxpow) {
        ...
        // We have to patch this because CraftCoin genesis block is invalid.
...
CAmount GetDogecoinBlockSubsidy(int nHeight, int nFees, const Consensus::Params& consensusParams, uint256 prevHash)
{
    ...
    if(nHeight >= 32000) // reduce reward by a factor of five after block 32000
    {
        nSubsidy = 2 * COIN;
    }
