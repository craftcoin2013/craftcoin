...
void Shutdown()
{
    ...
    RenameThread("craftcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/craftcoin-community/craftcoin>";
    const std::string URL_WEBSITE = "<https://github.com/craftcoin-community/craftcoin>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("craftcoin-loadblk");
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // craftcoin: Do we need to do any RPC mining init here?
