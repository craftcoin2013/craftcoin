...
public:
    ...
    QLabel *labelPriorityLow;
    QSpacerItem *horizontalSpacer_7;
    QLabel *confirmationTargetLabel;
    QSpacerItem *horizontalSpacer_3;
    QLabel *labelPriorityHigh;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelPriority = new QLabel(frameFeeSelection);
        labelPriority->setObjectName(QStringLiteral("labelPriority"));
        labelPriority->setMargin(2);

        horizontalLayoutFee12->addWidget(labelPriority);
        ...
        labelPriority3 = new QLabel(frameFeeSelection);
        labelPriority3->setObjectName(QStringLiteral("labelPriority3"));
        labelPriority3->setMargin(2);

        verticalLayoutFee6->addWidget(labelPriority3);
        ...
        labelPriorityLow = new QLabel(frameFeeSelection);
        labelPriorityLow->setObjectName(QStringLiteral("labelPriorityLow"));

        horizontalLayoutFee10->addWidget(labelPriorityLow);
        ...
        labelPriorityHigh = new QLabel(frameFeeSelection);
        labelPriorityHigh->setObjectName(QStringLiteral("labelPriorityHigh"));

        horizontalLayoutFee10->addWidget(labelPriorityHigh);
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for craftcoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for craftcoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        labelPriority3->setText(QApplication::translate("SendCoinsDialog", "Priority:", Q_NULLPTR));
        labelPriorityLow->setText(QApplication::translate("SendCoinsDialog", "low", Q_NULLPTR));
        labelPriorityHigh->setText(QApplication::translate("SendCoinsDialog", "high", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
