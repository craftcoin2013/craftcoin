...
void protobuf_AssignDesc_paymentrequest_2eproto() {
  ...
  static const int PaymentDetails_offsets_[7] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PaymentDetails, genesis_),
...
void protobuf_ShutdownFile_paymentrequest_2eproto() {
  ...
  delete PaymentDetails::_default_genesis_;
...
void protobuf_AddDesc_paymentrequest_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\n\016PaymentDetails\022Q\n\007genesis\030\001 \001(\t:@1a91e"
    "3dace36e2be3bf030a65679fe821aa1d6ef92e7c"
    "9902eb318182c355691\022!\n\007outputs\030\002 \003(\0132\020.p"
    "ayments.Output\022\014\n\004time\030\003 \002(\004\022\017\n\007expires\030"
    ...
    "ertificate\030\001 \003(\014\"i\n\007Payment\022\025\n\rmerchant_"
    "data\030\001 \001(\014\022\024\n\014transactions\030\002 \003(\014\022#\n\trefu"
    "nd_to\030\003 \003(\0132\020.payments.Output\022\014\n\004memo\030\004 "
    "\001(\t\">\n\nPaymentACK\022\"\n\007payment\030\001 \002(\0132\021.pay"
    "ments.Payment\022\014\n\004memo\030\002 \001(\tB*\n com.craft"
    "coin.protocols.paymentsB\006Protos", 711);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "paymentrequest.proto", &protobuf_RegisterTypes);
  Output::default_instance_ = new Output();
  PaymentDetails::_default_genesis_ =
      new ::std::string("1a91e3dace36e2be3bf030a65679fe821aa1d6ef92e7c9902eb318182c355691", 64);
...
::std::string* PaymentDetails::_default_genesis_ = NULL;
#ifndef _MSC_VER
const int PaymentDetails::kGenesisFieldNumber;
...
void PaymentDetails::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
  genesis_ = const_cast< ::std::string*>(_default_genesis_);
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 125) {
    ...
    if (has_genesis()) {
      if (genesis_ != _default_genesis_) {
        genesis_->assign(*_default_genesis_);
      }
    }
    if (has_memo()) {
      if (memo_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
      ...
      case 1: {
        if (tag == 10) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_genesis()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->genesis().data(), this->genesis().length(),
